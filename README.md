...
# 🖼️ Linux Wallpaper Engine (`illogical-impulse` integration fork)
...
> [!IMPORTANT]
> This fork was custom made for my own `illogical-impulse` set up. This *should* have a lot of fixes that makes previously unusable wallpapers now compatible with this module (e.g. [this KAngel wallpaper](https://steamcommunity.com/sharedfiles/filedetails/?id=3417601930))
>
> **HOWEVER**, I am **NOT** responsible for any bugs or regressions that may arise from these modifications. It is maintained for as long as I'm using it, but it is purely made for my own personal needs. Anything falls outside of this scope will probably not be considered. 
> 
